...
const KEYMAP: KeymapEntry[] = [
  ...
  { mode: "normal", context: "sidebar", key: "x",  command: { type: "action", action: "unwrap_folder" } },
  ...
  { mode: "visual", context: "prompt", key: "D",  command: { type: "standalone", name: "visual_delete_yank" } },
  ...
  { mode: "visual-line", context: "prompt", key: "D",  command: { type: "standalone", name: "visual_delete_yank" } },
