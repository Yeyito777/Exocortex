...
# System Prompts
Keep system prompts minimal and mainly referential: point to relevant files, tools, and documentation rather than duplicating them. Keep current tasks and transient state out of prompts.
