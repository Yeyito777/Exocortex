 ...
 */
function emitTailDiff(before: ContentBlock[], after: ContentBlock[], cb: StreamCallbacks): boolean {
...
function emitOrSyncBlocks(before: ContentBlock[], after: ContentBlock[], cb: StreamCallbacks): void {
